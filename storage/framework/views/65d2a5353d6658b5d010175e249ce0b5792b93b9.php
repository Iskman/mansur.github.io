...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		<ul class="nav navbar-nav">
			<li class="<?php if($page == 'welcome'): ?> active <?php endif; ?>"><a href="http://pgu-parser.kz/">ГЛАВНАЯ</a></li>
			<li class="<?php if($page == 'about'): ?> active <?php endif; ?>"><a href="http://pgu-parser.kz/about">О САЙТЕ</a></li>
			<li class="<?php if($page == 'howitis'): ?> active <?php endif; ?>"><a href="http://pgu-parser.kz/howitis">КАК РАЗРАБАТЫВАЛОСЬ</a></li>
			<!-- <li class="<?php if($page == 'home'): ?> active <?php endif; ?>"><a href="#" id='JOKER'>ДЛЯ КРАСОТЫ</a></li> -->
		</ul>
	</div>
</nav>
...
</script><?php /**PATH C:\OpenServer\OSPanel\domains\pgu-parser.kz\resources\views/header.blade.php ENDPATH**/ ?>